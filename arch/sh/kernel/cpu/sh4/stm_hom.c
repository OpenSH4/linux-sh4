...
static struct stm_mem_hibernation *platform_hom hom_data_section;
unsigned long stm_hom_saved_stack_value hom_data_section;
/*
 * stm_hom_boot_stack is a mini stack in uncached.data
 */
unsigned long stm_hom_boot_stack[THREAD_SIZE / 4] hom_data_section;
 ...
 */
static void hom_code_section stm_hom_tmu1_restart(void)
{
	unsigned char tmp;
 ...
 */
void hom_code_section stm_hom_cache_init(void)
{
 ...
 */
static void hom_code_section stm_hom_pgd_setup(void)
{
...
static int hom_code_section stm_hom_enter(void)
{
