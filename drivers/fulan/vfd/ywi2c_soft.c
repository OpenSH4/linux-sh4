...
#include "ywgpio_def.h"
#include "ywgpio_ext.h"

#include "ywi2c_soft.h"
...
//static YWI2C_SoftParam_t   SoftI2c;
...
//EXPORT_SYMBOL(softi2c_init);
//EXPORT_SYMBOL(softi2c_cleanup);

#if 0
module_init(softi2c_init);
module_exit(softi2c_cleanup);
#endif  /* 0 */
#endif  /* 0 */
