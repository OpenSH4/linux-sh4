...
/*****     2012-04-24     *****/
//YWDRIVER_MODI del by lf for option里面已经支持了 start
#if 0
#define HUAWEI_PRODUCT_E1550_ID	0x140c  //YWDRIVER_MODI lwj add
#define HUAWEI_VENDOR_ID		0x12D1  //YWDRIVER_MODI lwj add
#endif
