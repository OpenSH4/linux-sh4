...
#if 1
// YWDRIVER_MODI cc changed 2009/10/23 for wrong address line begin
/*********************************************************************/
	...
	if (ctrl & NAND_CTRL_CHANGE) {
		...
		if (ctrl & NAND_CLE) {
			this->IO_ADDR_W = (void *)((unsigned int)this->IO_ADDR_W |
						   (unsigned int)(1 << 17)); //17:newboard, 18:oldboard
		}
		else {
			this->IO_ADDR_W = (void *)((unsigned int)this->IO_ADDR_W &
						   ~(unsigned int)(1 << 17)); //17:newboard, 18:oldboard
		...
		if (ctrl & NAND_ALE) {
			this->IO_ADDR_W = (void *)((unsigned int)this->IO_ADDR_W |
						   (unsigned int)(1 << 18));  //18:newboard, 19:oldboard
		}
		else {
			this->IO_ADDR_W = (void *)((unsigned int)this->IO_ADDR_W &
						   ~(unsigned int)(1 << 18));  //18:newboard, 19:oldboard
...
/***************************************************************************/
// YWDRIVER_MODI cc changed 2009/10/23 for wrong address line end
