...
void  __init stx7108_configure_lpm(int number_i2c, int number_gpio)
{
	struct stm_plat_lpm_data *plat_data =
			stx7108_lpm_device.dev.platform_data;
	plat_data->number_i2c=number_i2c;
	plat_data->number_gpio=number_gpio;
	platform_device_register(&stx7108_lpm_device);
}
